...
ave_attns = [[0] * 40 for _ in range(40)]
ave_attns2 = [[0] * 40 for _ in range(40)]
num_attns = 0
with open('result_attn_source_14B.jsonl', 'a', encoding='utf-8') as outf:
  for pid in pid_list:
    user_content_prefix = '''
    ...
    for encoded_cnt in range(1, encoded_cnt_max + 1):
      ...
      if (len(attns) == 0):
        continue
      print(len(attns), len(attns[0]), "shape of the output")
...
with open('result_attn_14B.jsonl', 'w', encoding='utf-8') as outf:
  out = {}
